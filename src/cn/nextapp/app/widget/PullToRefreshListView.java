...
//    	if (currentScrollState == SCROLL_STATE_FLING && firstItemIndex == 0 && state != REFRESHING) {
//            setSelection(1);
//    	}
//    	else if(currentScrollState == SCROLL_STATE_FLING && headView.getBottom() >= 0 && state != REFRESHING){
//    		setSelection(1);
//    	}
    }  
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {  
    	...
    	//System.out.println("============>CurrentScrollState: "+ scrollState);
    }  
...
//                if((headView.getBottom() >= headContentHeight + 20 || headView.getTop() >= 0)
//                        && state != RELEASE_To_REFRESH) {
//                    state = RELEASE_To_REFRESH;
//                    changeHeaderViewByState();  
//                } else if (headView.getBottom() < headContentHeight + 20
//                        && state != PULL_To_REFRESH) {
//                    state = PULL_To_REFRESH;
//                    changeHeaderViewByState();  
//                }
